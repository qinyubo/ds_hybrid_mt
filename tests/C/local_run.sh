...
mpirun -n 1 ./dataspaces_server -s 1 -c 12 >& $DIR/server_$CONF_DIMS.log & SERVER_PID=$!
echo "SERVER_PID: $SERVER_PID"
sleep 2

mpirun -n 8 $DIR/test_writer DATASPACES 8 2 8 1 $CONF_DIMS/8 $CONF_DIMS 10 1 > $DIR/writer_$CONF_DIMS.log 2>&1 &
mpirun -n 4 $DIR/test_reader DATASPACES 4 2 4 1 $CONF_DIMS/4 $CONF_DIMS 10 2 > $DIR/reader_$CONF_DIMS.log 2>&1 & READER_PID=$!
