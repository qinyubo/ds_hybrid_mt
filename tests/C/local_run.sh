...
mpirun -n 4 $DIR/test_writer DATASPACES 4 2 4 1 $CONF_DIMS/4 $CONF_DIMS 1 1 > $DIR/writer_$CONF_DIMS.log 2>&1 &
mpirun -n 1 $DIR/test_reader DATASPACES 1 2 1 1 $CONF_DIMS $CONF_DIMS 1 2 > $DIR/reader_$CONF_DIMS.log 2>&1 & READER_PID=$!
